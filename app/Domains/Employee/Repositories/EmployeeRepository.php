...
class EmployeeRepository extends BaseRepository
{
    ...
    public function search(array $filters): LengthAwarePaginator
    {
        ...
        $sortBy = in_array($filters['sort_by'] ?? null, ['employee_no', 'first_name', 'last_name', 'hire_date', 'employment_status_id'], true) ? $filters['sort_by'] : 'last_name';
        ...
        return $this->query()
            ...
            ->when($filters['employment_status_id'] ?? null, fn ($query, $value) => $query->where('employment_status_id', $value))
